...
- **Model + effort (`sonnet` / `medium`) are calibrated via 6-variant × 10-round tournament (ADR 0063).** Winner picked on plan reasoning + execution combined: perfect-run rate 8/10, perfect plan quality 3.00/3.00, narrow win over haiku/medium runner-up (avg 2.80 vs 2.70). Re-tournament after a notable prompt-body change.
