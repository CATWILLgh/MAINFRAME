...
func expectedCommandCapabilities() []commandCapability {
	return []commandCapability{
		...
		{ID: "credentials.legacy-indexes", Usage: "mainframe credentials legacy-indexes", Summary: "Inspect legacy adapter credential indexes without returning their content.", Input: inputNone, Output: outputJSON, Effect: effectReadOnly, Confirmation: confirmationNone, Documentation: "credentials"},
