...
func expectedCommandCapabilities() []commandCapability {
	return []commandCapability{
		...
		{ID: "credentials.instance.review", Usage: "mainframe credentials instance review", Summary: "Review a credential-instance create, edit, or delete request.", Input: inputJSON, Output: outputJSON, Effect: effectReadOnly, Confirmation: confirmationNone, Documentation: "credentials"},
		...
		{ID: "credentials.legacy-review", Usage: "mainframe credentials legacy-review", Summary: "Review legacy transfer choices without writing.", Input: inputJSON, Output: outputJSON, Effect: effectReadOnly, Confirmation: confirmationNone, Documentation: "credentials"},
		{ID: "credentials.secret-retire.apply", Usage: "mainframe credentials secret-retire apply --confirm <digest>", Summary: "Apply an exact reviewed secret retirement request.", Input: inputJSON, Output: outputJSON, Effect: effectReviewedWrite, Confirmation: confirmationDigest, Documentation: "credentials"},
		{ID: "credentials.secret-retire.prepare", Usage: "mainframe credentials secret-retire prepare <name>", Summary: "Prepare secret retirement after proving no managed references remain.", Input: inputArguments, Output: outputJSON, Effect: effectPreparationWrite, Confirmation: confirmationNone, Documentation: "credentials"},
