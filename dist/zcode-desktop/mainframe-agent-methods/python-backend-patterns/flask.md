...
- Split large blueprint into a package (`api/<resource>/`) when the file exceeds the umbrella file-size rule (AGENTS.md): one module per concern (crud, lifecycle, attachments, etc).
