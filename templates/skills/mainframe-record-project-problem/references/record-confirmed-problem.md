...
scope review must establish every affected location, blast radius, and next
lifecycle state. Do not search open or archived tickets, merge records, or
update an existing ticket. A later refinement run owns duplicate detection and
consolidation.
