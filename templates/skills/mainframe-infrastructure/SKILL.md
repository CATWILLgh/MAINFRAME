...
Use this method within the assigned infrastructure scope and authority, whether
working directly or as a delegate. Return any missing environment, downtime,
data, or access decision to the immediate caller. Other matching skills may
refine a branch, but their absence does not block this method.
...
- Dockerfile, image, or Compose work: read [containers.md](references/containers.md).
- PostgreSQL or Redis operational work: read [data-stores.md](references/data-stores.md).
- Any infrastructure change or diagnosis: read
  [verification.md](references/verification.md) before declaring the result complete.
