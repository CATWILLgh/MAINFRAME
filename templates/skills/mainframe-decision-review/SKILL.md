...
description: Challenge a consequential proposed decision against evidence and realistic failure modes before acceptance. Do not use for routine choices or general defect discovery.
---
...
Use this structure in the current recipient's language:
...
Review the proposal without implementing it or expanding into unrelated defects.
This method is usable directly or by a separate reviewer. State whether the
review is independent of the proposal's author. Return findings to the current
recipient; the assigned decision owner reconciles them before acceptance.
