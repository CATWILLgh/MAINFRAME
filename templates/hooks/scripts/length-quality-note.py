...
Supply exact before/after snapshots for a successful edit. Comparing the two
avoids blaming inherited oversized code on the current writer. The target
integration owns snapshot capture and the event binding.
...
structural checks belong in project testing layers.
"""
