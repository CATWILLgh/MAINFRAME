"""Shared suppression and diagnostic-residue detectors for edit and stop checks."""
...
# file would turn ordinary strings naming suppression directives into a
...
# Extension-gated because breakpoint('md') can be a responsive-design
