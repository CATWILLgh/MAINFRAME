...
1. Read current official documentation for the host's user instructions and
   ...
   Use built-in guides to locate relevant sources; if sources disagree, retain
   the conflict and inspect the competing documented locations narrowly.
...
4. Identify concrete items worth discussing: references to another tool,
   ...
   certainty beyond evidence. Show the relevant text and practical consequence.
...
If nothing merits discussion, report the checked scope without manufacturing
cleanup. If this review was requested during an installation brief, return to
