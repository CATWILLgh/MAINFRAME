...
def test_skill_projection_keeps_supported_frontmatter_and_rewrites_bindings() -> None:
    ...
    adapted = build.adapt_runtime_markdown("Use `~/.claude/skills/mainframe/skills/sample/tool.py`, `AskUserQuestion`, and `ExitPlanMode`.")
