...
INSTALL_UNIT_MATERIALIZATION_SCHEMA_VERSION = 8
BUNDLE_REQUIRED_FIELDS = {
    ...
    INSTALL_UNIT_MATERIALIZATION_SCHEMA_VERSION: BUNDLE_FIELDS_V2,
}
BUNDLE_FIELDS = {
    2: BUNDLE_FIELDS_V2,
    HOST_REQUIREMENTS_SCHEMA_VERSION: BUNDLE_FIELDS_V2 | {"host_requirements"},
    ...
    INSTALL_UNIT_MATERIALIZATION_SCHEMA_VERSION: BUNDLE_FIELDS_V2 | {"host_requirements"},
}
...
UNIT_MATERIALIZATION_FIELDS = UNIT_FEATURE_FIELDS | {"materialization"}
