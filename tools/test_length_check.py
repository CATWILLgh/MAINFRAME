#!/usr/bin/env python3
"""Tests for _length_check.py: generated-file classification, count_lines,
python_function_spans, over_threshold_functions, FILE_LENGTH_EXTENSIONS.
...
def test_machine_generated_comment_header_is_detected():
    src = (
        "/* API client */\n"
        "// Generated by an API client generator.\n"
        "// Do not edit manually.\n"
    )
    assert lc.is_machine_generated(src)


def test_machine_generated_header_markers_are_case_insensitive():
    assert lc.is_machine_generated("# @GENERATED\n")
    assert lc.is_machine_generated(
        "<!-- This file was generated from a schema. DO NOT EDIT. -->\n")
    assert lc.is_machine_generated("/** Generated by Example Tool. */\n")
    assert lc.is_machine_generated(
        "# DO NOT EDIT: automatically generated file.\n")


def test_machine_generated_docstring_continuation_is_detected():
    src = (
        '"""\n'
        "My API\n"
        "\n"
...
def test_machine_generated_this_code_declaration_is_detected():
    assert lc.is_machine_generated("// This code was generated by a tool.\n")


def test_human_generator_marker_literals_are_not_generated_header():
    src = (
        'GENERATED_MARKER = "Generated from MAINFRAME hub"\n'
        '_NOTE = "# {marker} — do not edit; regenerate via build.py"\n'
    )
    assert not lc.is_machine_generated(src)


def test_human_generator_description_is_not_generated_declaration():
    src = "# Helpers for files generated by this module.\n"
    assert not lc.is_machine_generated(src)
    assert not lc.is_machine_generated(
        "# Automatically generated reports are written to build/.\n")
