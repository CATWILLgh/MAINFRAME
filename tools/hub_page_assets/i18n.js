...
window.HUB_STRINGS_RU = {
  ...
  "cancelled": "отменено",
  "sessions": "сессий",
  "Parallel sessions": "Параллельные сессии",
  "complete runs": "полных запусков",
  "peak active": "максимум одновременно",
  "sessions overlapping": "сессий с пересечением",
  "overlap time": "время пересечения",
  "unpaired boundaries": "границ без пары",
  "Measured only from paired session start and end events. Partial means at least one boundary falls outside the selected period or was never observed; missing boundaries are not guessed.":
    "Считается только по парным событиям начала и конца сессии. «Частично» означает, что хотя бы одна граница оказалась вне выбранного периода или не была записана; отсутствующие границы не додумываются.",
  "No paired session boundaries have been recorded.": "Парные границы сессий пока не записаны.",
  "agent": "агент",
  "project": "проект",
  "state": "состояние",
  "active": "активен",
