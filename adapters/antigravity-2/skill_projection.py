...
def _rewrite_workflow_skill(text: str, label: str) -> str:
    replacements = (
        ("Plan files land in `~/.claude/plans/<basename(cwd)>/<YYYY-MM-DD>-<topic>.md`", "Plan audit copies land in `~/.gemini/antigravity/mainframe-plans/audit/<basename(cwd)>/<YYYY-MM-DD>-<topic>.md`"),
