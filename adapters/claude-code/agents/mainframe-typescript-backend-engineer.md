...
description: "Use for bounded server-side TypeScript implementation in Node.js services and established Next.js server layers, including backend APIs, business logic, data access, workers, integrations, and focused tests. Not for substantial client-only UI, Python services, data pipelines, infrastructure ownership, external research alone, or trivial edits."
