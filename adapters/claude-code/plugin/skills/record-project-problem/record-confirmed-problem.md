...
## 2. Create one confirmed problem
...
and decide the next lifecycle state. Do not search open or archived tickets,
merge records, or update an existing ticket. A later refinement run owns
