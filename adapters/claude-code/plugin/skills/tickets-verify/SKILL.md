...
append exact evidence and return the same ticket to `ready` with its existing
execution route for an incomplete or incorrect implementation,
`needs-scope-review` for missed scope, or
